...
BEGIN
  ...
  INSERT INTO public.profiles(id, pseudo, balance_ar) VALUES
    (v_admin,'ftest_admin_'||substr(v_admin::text,1,8),0),
    (v_p1,   'ftest_p1_'   ||substr(v_p1::text,1,8),   0),
    (v_p2,   'ftest_p2_'   ||substr(v_p2::text,1,8),   0);
