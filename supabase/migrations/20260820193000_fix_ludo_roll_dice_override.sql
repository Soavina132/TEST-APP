-- ═════════════════════════════════════════════════════════════════
-- FIX: "record 'g' has no field 'dice_override'"
--
-- Cause : la colonne dice_override a été droppée par la migration
-- 20260819210000_ludo_security_lockdown.sql, mais la fonction ludo_roll
-- la référençait encore (g.dice_override).
--
-- Solution : recréer ludo_roll SONS aucune référence à dice_override.
-- Garde la logique de no_move_display (1s) et du triple six.
-- ═════════════════════════════════════════════════════════════════
