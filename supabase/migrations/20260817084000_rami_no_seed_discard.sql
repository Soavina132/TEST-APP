-- ═══ Fix: Pas de carte seed sur la défausse au démarrage ═══
-- La défausse commence VIDE. Le 1er carte sera celui défaussé par l'humain.
...
BEGIN
  ...
  -- ═══ HUMAIN = SLOT 0 (14 cartes, joue en 1er) ═══
  ...
  -- ═══ PAS DE CARTE SEED SUR LA DÉFAUSSE — défausse vide au départ ═══
  ...
  -- ═══ L'humain joue en 1er, pas de bot à déclencher ═══
  RETURN v_game_id;
END $function$;
