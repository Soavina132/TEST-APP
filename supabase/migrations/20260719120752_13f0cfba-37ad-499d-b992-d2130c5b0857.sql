...
BEGIN
  ...
  -- Le trigger on_auth_user_created crée déjà la ligne profiles ; on force les valeurs utiles
  UPDATE public.profiles SET balance_ar = 0 WHERE id IN (v_admin, v_p1, v_p2);
