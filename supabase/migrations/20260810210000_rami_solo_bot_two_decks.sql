-- ═══ Fix rami_start_solo_bot: use 2 decks (104 cards) like rami_start ═══
-- The multiplayer rami_start already uses 2 decks since migration 20260802201750.
-- This updates the solo-bot version to match.
