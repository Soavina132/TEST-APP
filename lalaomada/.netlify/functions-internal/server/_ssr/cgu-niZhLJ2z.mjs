...
import { A as ArrowLeft, a4 as FileText } from "../_libs/lucide-react.mjs";
...
function CguPage() {
  ...
  reactExports.useEffect(() => {
    supabase.from("app_settings").select("terms_html, terms_text").eq("id", 1).maybeSingle().then(({
      data
    }) => {
      setHtml(data?.terms_html || data?.terms_text || "");
      setLoaded(true);
    });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-2xl mx-auto px-4 py-5 space-y-4 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-extrabold", children: "Conditions d'utilisation" })
    ] }),
    ...
    } }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground text-center py-8", children: "Le contenu des conditions d'utilisation n'est pas encore disponible." }) })
  ] });
}
export {
  CguPage as component
};
