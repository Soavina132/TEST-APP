      ...
      <section>
        ...
        {games.length === 0 ? (
          <div className="rounded-2xl bg-card border border-border p-3 text-center">
            <Gamepad2 className="w-7 h-7 text-muted-foreground/40 mx-auto mb-1.5" />
            <p className="font-bold text-xs text-muted-foreground">Aucune partie ouverte</p>
            <p className="text-[10px] text-muted-foreground mt-0.5">Créez-en une depuis l'onglet Jeux</p>
            <Link to="/jeux"
              className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary text-primary-foreground text-xs font-bold">
