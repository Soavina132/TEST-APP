...
function LoginPage() {
  ...
  const onGoogleSignIn = async () => {
    ...
    if (error) toast.error(error.message || "Erreur connexion Google");
  };
        ...
        <div className="bg-card border border-border rounded-2xl shadow-sm p-6">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button
              ...
              disabled={busy}
              className="w-full py-3 rounded-xl border border-border bg-card text-foreground font-semibold text-sm hover:bg-secondary/40 active:scale-[.98] transition-all disabled:opacity-60 flex items-center justify-center gap-2.5"
            >
