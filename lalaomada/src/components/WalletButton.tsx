    ...
    <>
      <div className="relative" ref={ref}>
        <button
          ...
          className="flex items-center gap-1.5 pl-2.5 pr-1 py-1 rounded-full bg-accent/60 hover:bg-accent border border-border/40 hover:border-border transition-all duration-200"
