-- FIX: ludo_quit — _ludo_finalize doesn't exist, use _ludo_check_game_over
-- Date: 2026-08-22 00:08
--
-- The original code called public._ludo_finalize() which never existed.
-- Replace with public._ludo_check_game_over() which handles:
-- counting remaining players, finding winner, calling finish_game().
