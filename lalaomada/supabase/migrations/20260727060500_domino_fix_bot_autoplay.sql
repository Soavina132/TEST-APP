-- Fix: _domino_autoplay_bots was a stub delegating back to _domino_bot_step,
-- creating a loop where the bot only re-armed its think timer and never played.
-- Restore the real play/draw/pass logic (adapted from 20260717 canonical version).
...
BEGIN
  ...
  -- Pas de tuile jouable : pioche si autorisé
