-- Fix: jsonb_set with nested path ['dead_tiles', '0'] doesn't create intermediate objects
-- Must build dead_tiles object separately, then set it as a single key in state
