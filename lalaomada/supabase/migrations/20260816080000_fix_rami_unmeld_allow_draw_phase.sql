-- ═══ Fix: permettre de reprendre une pose pendant la phase 'draw' aussi ═══
--
-- Avant: rami_unmeld exigeait turn_phase = 'play' → impossible de
-- reprendre une combinaison au début du tour avant d'avoir pioché.
-- Maintenant: accepte 'draw' ET 'play'.
