-- Fix: la migration 20260812080000 a remplacé domino_tick en supprimant
-- la logique de délégation aux bots (_domino_bot_step). Les bots ne jouaient plus.
-- Cette migration restaure la logique bot + garde le fix turn_slot.
