-- ═══ First player gets 14 cards and starts in 'play' phase (skip draw) ═══
-- In traditional Rami, the first player gets 14 cards and plays immediately
-- instead of drawing first. This gives them the first move advantage.
...
BEGIN
  ...
  -- Deal cards: first player gets 14, others get 13
  ...
  UPDATE public.rami_games SET
    ...
    current_turn=0, turn_phase='play',  -- First player starts in 'play' phase (already has 14 cards)
