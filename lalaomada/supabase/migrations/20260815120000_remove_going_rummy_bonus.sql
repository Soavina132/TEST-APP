-- ============================================================
-- REVERT Going Rummy bonus — causes platform financial loss
--
-- The platform takes 10% commission from the pot.
-- 7-card mode refunds the winner's stake.
-- Going Rummy bonus (extra 10% pot) was coming from nowhere → removed.
--
-- This migration reverts rami_meld, rami_discard, and rami_validate_hand
-- to versions WITHOUT the going_rummy bonus payout, but KEEPS:
--   - pure flag on melds (for frontend Pure/Impure badges)
--   - first_melds tracking (harmless metadata)
--   - action_log improvements
-- ============================================================

-- ═══ 1. rami_meld: keep pure flag + first_melds, NO going_rummy ═══
...
-- ═══ 2. rami_discard: NO going_rummy bonus, keep pure flag on melds ═══
...
-- ═══ 3. rami_validate_hand: NO going_rummy bonus ═══
