...
REVOKE EXECUTE ON FUNCTION public.fanorona_create(numeric, boolean, numeric, text, boolean) FROM anon;
GRANT EXECUTE ON FUNCTION public.fanorona_create(numeric, boolean, numeric, text, boolean) TO authenticated;
