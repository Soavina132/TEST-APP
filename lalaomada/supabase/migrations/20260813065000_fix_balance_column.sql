-- FIX: column "balance" does not exist — should be "balance_ar"
-- Three domino functions used 'balance' instead of 'balance_ar':
--   - domino_create: deducted stake from wrong column
--   - domino_end_round: paid winnings to wrong column
--   - domino_forfeit_internal: paid forfeit winnings to wrong column
-- Also removed bot_think_until from domino_create initial state (cleanup).
