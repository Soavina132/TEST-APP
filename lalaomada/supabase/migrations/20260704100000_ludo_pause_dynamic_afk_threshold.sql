-- ================================================================
-- Ludo pause eligibility must track the admin-configured AFK
-- threshold (app_settings.afk_t1_max / afk_t2_max), not a
-- hardcoded "2". The admin just raised it from 2/2 to 3/3, so the
-- pause trigger has to follow that value dynamically from now on
-- (and any future change made from the admin panel).
-- ================================================================
