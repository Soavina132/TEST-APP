-- ═════════════════════════════════════════════════════════════════
-- FIX: Domino par point — v_total jamais initialisé → score toujours 0
--
-- En PL/pgSQL, v_total int; → NULL par défaut.
-- NULL + v_pips = NULL → GREATEST(0, NULL) = 0 → round_score toujours 0.
-- Fix : initialiser v_total := 0.
-- ═════════════════════════════════════════════════════════════════
...
DECLARE
  ...
  v_slot int;
  v_pts int;
  v_total int := 0;        -- FIX: initialiser à 0, sinon NULL + x = NULL
  v_rounds int;
